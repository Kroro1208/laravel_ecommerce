                                ...
                                <div class="w-full overflow-auto">
                                    <table class="w-full table-auto mx-auto text-left whitespace-no-wrap">
                                        <thead>
                                            <tr>
                                                <th
                                                    class="md:px-6 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">
                                                    名前</th>
                                                <th
                                                    class="md:px-6 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                    メールアドレス</th>
                                                <th
                                                    class="md:px-6 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                    作成日</th>
                                        ...
                                        <tbody>
                                            @foreach ($owners as $owner)
                                                <tr>
                                                    <td class="md:px-6 py-3">{{ $owner->name }}</td>
                                                    <td class="md:px-6 py-3">{{ $owner->email }}</td>
                                                    <td class="md:px-6 py-3">{{ $owner->created_at->diffForhumans() }}</td>
